            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.procedures.store') }}" id="procedureForm">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" id="category"
                                        ...
                                        <option value="crown" {{ old('category') == 'crown' ? 'selected' : '' }}>Crown
                                        </option>
                                        <option value="bridge" {{ old('category') == 'bridge' ? 'selected' : '' }}>Bridge
                                        </option>
                                        <option value="veneer" {{ old('category') == 'veneer' ? 'selected' : '' }}>Veneer
                                        </option>
                                        <option value="implant" {{ old('category') == 'implant' ? 'selected' : '' }}>Implant
                                        </option>
                                        <option value="denture" {{ old('category') == 'denture' ? 'selected' : '' }}>Denture
                                        </option>
                                    </select>
                                </div>
                            </div>
