            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('admin.procedures.index') }}" class="btn btn-sm btn-secondary me-2">Back to
                                Procedures</a>
                            <a href="{{ route('admin.procedures.edit', $procedure) }}" class="btn btn-sm btn-warning">Edit
                                Procedure</a>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        @if ($procedure->color)
                                            <div class="d-flex flex-wrap gap-2">
                                                <span class="badge bg-secondary p-2">{{ $procedure->color->name }}</span>
                                            </div>
                                        @else
