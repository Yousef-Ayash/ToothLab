            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.procedures.index') }}" class="btn btn-sm btn-secondary">Back to
                            Procedures</a>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $procedure->name) }}" required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" id="category"
                                        ...
                                        <option value="crown"
                                            {{ old('category', $procedure->category) == 'crown' ? 'selected' : '' }}>Crown
                                        </option>
                                        <option value="bridge"
                                            {{ old('category', $procedure->category) == 'bridge' ? 'selected' : '' }}>Bridge
                                        </option>
                                        <option value="veneer"
                                            {{ old('category', $procedure->category) == 'veneer' ? 'selected' : '' }}>Veneer
                                        </option>
                                        <option value="implant"
                                            {{ old('category', $procedure->category) == 'implant' ? 'selected' : '' }}>
                                            Implant</option>
                                        <option value="denture"
                                            {{ old('category', $procedure->category) == 'denture' ? 'selected' : '' }}>
                                            Denture</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" min="0"
                                        ...
                                        name="cost" value="{{ old('cost', $procedure->cost) }}" required>
                                </div>
                                {{-- <div class="col-md-6">
                                    ...
                                    <select id="color_id" name="color_id"
                                        ...
                                        @foreach ($colors as $color)
                                            <option value="{{ $color->id }}"
                                                {{ old('color_id', $procedure->color_id) == $color->id ? 'selected' : '' }}>
                                                {{ $color->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="3" required>{{ old('description', $procedure->description) }}</textarea>
                                </div>
                            </div>
                                        ...
                                        <div class="step-item card mb-3">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-sm btn-danger remove-step">Remove</button>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                ...
                                                <input type="hidden" name="steps[{{ $index }}][order]"
                                                    value="{{ $index + 1 }}" class="step-order">
                                            </div>
                                        </div>
                                    @endforeach
                                @else
