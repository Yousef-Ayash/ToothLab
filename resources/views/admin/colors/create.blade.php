                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="color" class="form-control form-control-color" id="color-picker" value="{{ old('code', '#ffffff') }}">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', '#ffffff') }}" required>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div id="color-preview" style="width: 100%; height: 100px; border-radius: 4px; border: 1px solid #ddd; background-color: {{ old('code', '#ffffff') }};"></div>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-1">This color will be available for:</p>
                                                <ul>
                                                    <li>Dental procedures that require color selection</li>
                                                    <li>Tooth coloring options</li>
                                                    <li>Material selection in orders</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
